...
function easing_slider() {
      ...
      <?php $recent = new WP_Query('cat='.$featcat.'&showposts='.$featpost.'');
        while($recent->have_posts()) : $recent->the_post(); global $post;
          $image = get_post_meta($post->ID, 'easing', true); if (!empty($image)) { ?>
                  <li><?php if($permalink == '') { ?><a href="<?php the_permalink(); ?>"><?php } ?><img src="<?php echo $image; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($permalink == '') { ?></a><?php } ?></li>
  ...
  <?php } else if(get_option('source') == 'custom') {
	...
	if ($sImg1) { ?>
		<li><?php if($sImglink1!='') echo '<a href="'. $sImglink1 .'">'; ?><img src="<?php echo $sImg1; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink1!='') echo '</a>'; ?></li><?php }

	if ($sImg2) { ?>
		<li><?php if($sImglink2!='') echo '<a href="'. $sImglink2 .'">'; ?><img src="<?php echo $sImg2; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink2!='') echo '</a>'; ?></li><?php }
		
	if ($sImg3) { ?>
		<li><?php if($sImglink3!='') echo '<a href="'. $sImglink3 .'">'; ?><img src="<?php echo $sImg3; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink3!='') echo '</a>'; ?></li><?php }
		
	if ($sImg4) { ?>
		<li><?php if($sImglink4!='') echo '<a href="'. $sImglink4 .'">'; ?><img src="<?php echo $sImg4; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink4!='') echo '</a>'; ?></li><?php }
		
	if ($sImg5) { ?>
		<li><?php if($sImglink5!='') echo '<a href="'. $sImglink5 .'">'; ?><img src="<?php echo $sImg5; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink5!='') echo '</a>'; ?></li><?php }
		
	if ($sImg6) { ?>
		<li><?php if($sImglink6!='') echo '<a href="'. $sImglink6 .'">'; ?><img src="<?php echo $sImg6; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink6!='') echo '</a>'; ?></li><?php }
		
	if ($sImg7) { ?>
		<li><?php if($sImglink7!='') echo '<a href="'. $sImglink7 .'">'; ?><img src="<?php echo $sImg7; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink7!='') echo '</a>'; ?></li><?php }
		
	if ($sImg8) { ?>
		<li><?php if($sImglink8!='') echo '<a href="'. $sImglink8 .'">'; ?><img src="<?php echo $sImg8; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink8!='') echo '</a>'; ?></li><?php }
		
	if ($sImg9) { ?>
		<li><?php if($sImglink9!='') echo '<a href="'. $sImglink9 .'">'; ?><img src="<?php echo $sImg9; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink9!='') echo '</a>'; ?></li><?php }
		
	if ($sImg10) { ?>
		<li><?php if($sImglink10!='') echo '<a href="'. $sImglink10 .'">'; ?><img src="<?php echo $sImg10; ?>" style="width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;" alt="<?php echo $images; ?>" /><?php if($sImglink10!='') echo '</a>'; ?></li><?php }
	...
	if ($sPagination=='yes') { ?>
                <div class="lof-navigator-wapper" style="bottom:<?php if($pageposition=='outside') echo '-35'; if($pageposition=='inside') echo '5'; ?>px;<?php if($pageside=='left') echo 'left: 40%'; if($pageside=='right') echo 'right:-10px'; ?>;padding:5px <?php if($pageposition=='outside') echo '5'; if($pageposition=='inside') echo '15'; ?>px;">
