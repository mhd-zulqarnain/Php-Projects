...
$con=mysqli_connect("mysql.2freehosting.com","u940906128_root","parvi167","u940906128_oss");
function Run($query){
    global $con;
             ...
             <div class="ad-item row">
                            <div class="item-image-box col-sm-4">
                                ...
                                <div class="item-image">
                                    <a href="detail.php?&pid='.$pid.'"><img src="visitors/images/'.$path.'" alt="Image" class="img-responsive"></a>
