...
window.Modernizr = (function( window, document, undefined ) {
    ...
    //
    // Codec values from : github.com/NielsLeenheer/html5test/blob/9106a8/Index.Partial#L845
...
$(document).ready(function() {
  ...
  $.ajax({
    url: discussions.data('feed-url') || "https://community.apachefriends.org/f/feed.Partial",
    dataType: 'xml',
